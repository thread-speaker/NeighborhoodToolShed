...
app.controller('profileCtrl', function($scope) {
	...
	*/
	...
	/*
		setClickOnChildrenTools()- sets the genus tool's object ".clicked" property to the oppositite of the boolean state it is in.
	...
	*/
	...
	/*
		isGenusToolOwned()- Scrolls through the user's owned tools and returns an index of the "passed in parameter tool" if it has the genus tool. Else it returns a -1.
		
						   tool: Tool object with genusTool, speciesTools[], and clicked properties.
		
						   return: the index of the genus tool in the ownedTools array. Else if not there, returns a -1
	*/
	...
	/*
		isToolOwned()- Scrolls through the user's owned tools and its speciesTool[] and returns an index of the "passed in parameter tool" if it has the exact tool. Else it returns a -1.
		
						   tool: Tool object with genusTool, speciesTools[], and clicked properties.
		
						   return: the index of the specific species tool in the ownedTools array. Else if not there, returns a -1
	*/
