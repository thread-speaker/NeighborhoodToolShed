...
app.controller('profileCtrl', function($scope) {
	...
	*/
	...
	$scope.topFriends = [ {name: "Cole Reasch", profileImg: "https://media.licdn.com/mpr/mpr/shrinknp_200_200/AAEAAQAAAAAAAAKvAAAAJDRkZjNhYmE5LTIzNWUtNGU0ZS04ZTBmLWVhMmYwZjY2NThmYg.jpg"},
			{name: "Hilary Clinton", profileImg: "http://cdn.thefiscaltimes.com/sites/default/files/styles/article_hero/public/media/Donald%20Trump_1.jpg?itok=i9IzVqSb"}, 
			{name: "Donald Trump", profileImg: "https://upload.wikimedia.org/wikipedia/commons/8/84/Hillary_Clinton_crop.jpg"}
		];
